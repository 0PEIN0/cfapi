...
function CodeforcesSettings() {
	...
	this.verdictTextReplacements = [ { source : null , destination : 'In queue' } , { source : 'ok' , destination : 'Accepted' } , { source : 'testing' , destination : 'Running' } , { source : 'challenged' , destination : 'Hacked' } , { source : '_' , destination : ' ' } , { source : 'failed' , destination : 'Judgement Failed' } ] ;
...
function CodeforcesTableStructures() {
	...
	self.submissionTableStructure = [ { name : 'Submission ID' , sortIndex : 'id' , currentlySorted : null } , { name : 'Server Date Time' , sortIndex : 'dateTime' , currentlySorted : null } , { name : 'User Handles' , sortIndex : 'handle' , currentlySorted : null , width : '230px' } , { name : 'Problem Name' , sortIndex : 'problemName' , currentlySorted : null , width : '190px' } , { name : 'Problem Tags' , sortIndex : 'problemTags' , currentlySorted : null , width : '120px' } , { name : 'User Solved' , sortIndex : 'userSolved' , currentlySorted : null } , { name : 'Language' , sortIndex : 'lang' , currentlySorted : null } , { name : 'Verdict' , sortIndex : 'verdict' , currentlySorted : null , width : '180px' } , { name : 'Time (in seconds)' , sortIndex : 'executionTime' , currentlySorted : null } , { name : 'Memory' , sortIndex : 'executionMemory' , currentlySorted : null } ] ;
	self.standingTableStructure = [ { name : 'Rank' , sortIndex : 'rank' , currentlySorted : null } , { name : 'Relative Rank' , sortIndex : 'relativeRank' , currentlySorted : null } , { name : 'Handle(s)' , sortIndex : 'handle' , currentlySorted : null , width : '230px' } , { name : 'Points' , sortIndex : 'points' , currentlySorted : null } , { name : 'Penalty' , sortIndex : 'penalty' , currentlySorted : null } , { name : 'Hacks' , sortIndex : 'hacks' , currentlySorted : null } ] ;

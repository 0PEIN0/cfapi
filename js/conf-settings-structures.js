...
function CodeforcesTableStructures() {
	...
	self.submissionTableStructure = [ { name : 'Submission ID' , sortIndex : 'id' , currentlySorted : null } , { name : 'Server Date Time' , sortIndex : 'dateTime' , currentlySorted : null } , { name : 'User Handles' , sortIndex : 'handle' , currentlySorted : null } , { name : 'Problem Name' , sortIndex : 'problemName' , currentlySorted : null } , { name : 'Problem Tags' , sortIndex : 'problemTags' , currentlySorted : null } , { name : 'User Solved' , sortIndex : 'userSolved' , currentlySorted : null } , { name : 'Language' , sortIndex : 'lang' , currentlySorted : null } , { name : 'Verdict' , sortIndex : 'verdict' , currentlySorted : null } , { name : 'Time (in seconds)' , sortIndex : 'executionTime' , currentlySorted : null } , { name : 'Memory' , sortIndex : 'executionMemory' , currentlySorted : null } ] ;
